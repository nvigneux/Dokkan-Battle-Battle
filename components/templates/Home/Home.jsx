    ...
    <div className={styles['dbb-container']}>
      <div className={styles['dbb-home']}>
        ...
        <div className={styles['dbb-home__description']}>
          ...
          <p>The principle and the rules were thought and created by the youtubers described below. <br /> I thank them for
            having
            ideas of multiplayer modes, so that everyone can share their passion of <strong>Dragon Ball Z Dokkan
              Battle</strong>.
          </p>
        </div>
        <div className={styles['dbb-home__mode']}>
          ...
          <div className={styles['dbb-home__yt']}>
            ...
            <div className={styles['home__yt--link']}>
              <a href="https://www.youtube.com/channel/UCYdop03CtRIi_0GUXSm2c9w" target="_blank">Fitz Adri</a>
              <a href="https://www.youtube.com/channel/UC-Bag_B3YkqvX2nEj28jgOA" target="_blank">Sussucre</a>
            </div>
          </div>
          <div className={styles['dbb-home__rules']}>
            ...
            <ul className={styles['home__rules--rule']}>
              ...
              <li>In case of duplicates draw, you need to delete the character in-game of your team and re draw a random line and
                column.
              </li>
              <li>Depends of the number of lines each player have you can draft a certains number of characters of your team
                :
              </li>
              <li> {`0 <> 10 lines = 1 Draft; 10 <> 20 lines = 2 Drafts; 20 <> More; 3 Drafts `}</li>
        ...
        <div className={styles['dbb-home__mode']}>
          ...
          <div className={styles['dbb-home__yt']}>
            ...
            <div className={styles['home__yt--link']}>
              <a href="https://www.youtube.com/channel/UCCyAzMaIWGw1vsCsL4IHbHQ" target="_blank">Yekais</a>
              <a href="https://www.youtube.com/channel/UCXd0OqDuxy9IZSglBWHL6sA" target="_blank">Fafa</a>
            </div>
          </div>
          <div className={styles['dbb-home__rules']}>
            < div className={styles['home__rules--title']}>
